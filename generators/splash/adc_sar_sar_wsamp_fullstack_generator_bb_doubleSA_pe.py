...
files=[
    ...
    'laygo/generators/splash/adc_sar_sarlogic_wret_array_layout_generator_bb_pe.py',
    ...
    'laygo/generators/splash/adc_sar_sarabe_dualdelay_layout_generator_bb_pe.py',
    #'laygo/generators/splash/adc_sar_sar_layout_generator.py',
    'laygo/generators/splash/adc_sar_sar_layout_generator_doubleSA_bb_pe.py',
    ...
    'laygo/generators/splash/adc_sar_sar_wsamp_schematic_generator_bb_doubleSA_pe.py',
    'laygo/generators/splash/adc_sar_sar_wsamp_layout_generator_bb_doubleSA_pe.py',

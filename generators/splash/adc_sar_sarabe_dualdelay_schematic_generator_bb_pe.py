...
cell_name = 'sarabe_dualdelay_bb_pe'
...
if load_from_file==True:
    ...
    cell_name = 'sarabe_dualdelay_bb_pe'#_'+str(specdict['n_bit'])+'b'
    ...
    params['logic_m_dl']=sizedict['sarlogic']['m_dl']
    params['logic_m_xor']=sizedict['sarlogic']['m_xor']
    params['logic_m_buf']=sizedict['sarlogic']['m_buf']

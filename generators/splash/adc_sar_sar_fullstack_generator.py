...
files=[
    ...
    'laygo/generators/splash/adc_sar_salatch_pmos_layout_generator.py',
    ...
    'laygo/generators/splash/adc_sar_sar_schematic_generator.py',
    'laygo/generators/splash/adc_sar_sar_lvs.py',
    ]

...
yaml_file = pkg_resources.resource_filename(__name__, os.path.join('netlist_info', 'sourceFollower_diff.yaml'))


# noinspection PyPep8Naming
class adc_sar_templates__sourceFollower_diff(Module):
    """Module for library adc_sar_templates cell sourceFollower_diff.

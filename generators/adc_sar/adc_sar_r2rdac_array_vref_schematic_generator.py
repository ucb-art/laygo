...
if load_from_file==True:
    ...
    params['m']=sizedict['r2rdac_vref']['m']
    params['m_bcap']=sizedict['r2rdac']['m_bcap']
    params['num_series']=sizedict['r2rdac_vref']['num_series']
    params['num_bits']=sizedict['r2rdac_vref']['num_bits']
    params['num_dacs']=3
